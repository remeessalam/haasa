    ...
    <div className="max-w-screen !overflow-hidden">
      <div className="wrapper py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-orange-500 font-medium mb-2">What we give</h2>
          <h1 className="text-[#1a237e] text-4xl font-bold mb-4">Our Values</h1>
        ...
        <div className="text-center mb-16">
          <h2 className="text-orange-500 font-medium mb-2">Work Process</h2>
          <h1 className="text-[#1a237e] text-4xl font-bold">
            Our Work Process
          </h1>
        </div>
