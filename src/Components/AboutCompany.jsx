      ...
      <div className="wrapper">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            ...
            {/* Experience Box */}
            <div
              className="absolute -bottom-20 left-0 bg-[#642190] text-white p-4 sm:p-8 rounded-3xl max-w-sm"
              data-aos="fade-up"
            >
          ...
          <div className="space-y-6 mt-16 sm:mt-0">
            ...
            <button
              className="bg-[#FF9B3E] text-black px-8 py-3 rounded-lg font-bold hover:bg-opacity-90 transition-colors"
              data-aos="fade-left"
