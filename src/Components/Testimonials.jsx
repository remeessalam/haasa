      ...
      <div className="wrapper grid lg:grid-cols-2 gap-10 w-full">
        ...
        >
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="testimonial-item bg-white opacity-0 absolute inset-0 w-full h-full flex flex-col justify-center p-5 rounded-3xl border-2 border-[#642190] shadow-2xl"
            >
              <img
                width="75"
                height="75"
